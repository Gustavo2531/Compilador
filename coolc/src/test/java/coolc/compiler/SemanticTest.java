...
public class SemanticTest {
	...
	// El compilador solo ensambla el comportamiento
	Compiler compiler;
	// La clase concreta del semanticFacade
	Class<?> klass;
	// Y la instancia (que se recrea cada prueba)
	SemanticFacade semanticFacade;
	
	/**
	 * Leer como CSV el archivo con la información de casos
	 * @param file
	 * @return
	 * @throws IOException
	 */
	...
	/**
	 * Al principio de cada test (conjunto de métodos)
	 * @param context
	...
	/**
	 * Antes de correr cada método se regenera el semanticFacade.
	 * 
	 * ATENCIÓN SI USAS SINGLETONS TIENES QUE BORRAR EL ESTADO AQUÍ.
	 * 
	...
	/**
	 * Prueba para casos de éxito.
	 * 
	 * Configurar el compilador con el facade y llamar al análisis semántico.
	 * 
	 * @param file
	 * @param testName
	...
	/**
	 * Para los casos de error se revista contra un set de errores. 
	 * @param file
	 * @param setTest
	 * @throws LexerException
	 * @throws IOException
	...
	public void testBad36() throws LexerException, IOException, ParserException, SemanticException {
		genericBad("letbadinit.cool", EnumSet.of(Error.BAD_LET_INIT));
	}
}
